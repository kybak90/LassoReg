...
The goal of LassoReg is to fit the Lasso regression model to a given set of data.

## Installation

You can install the development version of LassoReg from [GitHub](https://github.com/) with:
